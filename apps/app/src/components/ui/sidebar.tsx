  ...
  return (
    <main
      ...
      className={cn(
        ...
        "data-[panel-shelf=shelf]:-translate-x-(--secondary-panel-width-mobile) data-[panel-shelf=shelf]:overflow-hidden data-[panel-shelf=shelf]:rounded-xl data-[panel-shelf=shelf]:shadow-xl data-[panel-shelf]:will-change-[translate]",

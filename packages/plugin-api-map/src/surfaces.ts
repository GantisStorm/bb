    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Use experimental_sessionImport to list local profiles, import cookies, or clear the shared managed Browser session while keeping import UI and policy in the plugin",
        ],
        apiSymbols: [
          ...
          "ExperimentalBrowserCookieImportSource",
